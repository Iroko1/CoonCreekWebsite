...
<body class="body-container">
  ...
  <div class="text-container">
    ...
    <div class="container-md">
        <!-- <iframe 
            src="http://www.youtube.com/embed?listType=playlist&list=UURG9J9XbYfDmI1BB6U0puzA">
        </iframe> -->
    </div>

    <!-- Either option is fine -->
    <!-- <div>
        <iframe src="https://calendar.google.com/calendar/embed?src=cooncreekbaptist%40gmail.com&ctz=America%2FChicago" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
    </div> -->
