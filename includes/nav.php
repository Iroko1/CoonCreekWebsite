    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/cooncreekbaptistchurch/view/ministries.php">TeamKID</a></li>
            <li><a class="dropdown-item" href="/cooncreekbaptistchurch/view/ministries.php">Youth Group</a></li>
            <li><a class="dropdown-item" href="/cooncreekbaptistchurch/view/ministries.php">TLC Women's Group</a></li>
          </ul>
        </li>
      </ul>
    </div>
